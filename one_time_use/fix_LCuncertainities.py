...
def modify_keplerflux():
    ...
    req_factor = kepler_noise/actual_noise
...
systems_tofix = ['july6_res_534','july13_nores_320','july13_nores_520','july13_res_590','july13_res_395','july13_res_850','july13_res_400','july13_nores_695','july13_nores_535','july13_nores_315','july13_nores_130','july13_nores_505','july13_res_774','july13_res_734','july13_res_189','july13_nores_514','july13_res_878','july13_nores_88','july13_nores_925','july13_res_530','july13_res_125','july13_res_500','july13_res_775','july13_res_475', 'july13_nores_180','july13_res_248','july13_res_843']
exclregion_file = open('/home/garvit/Downloads/Exomoon_project/excl_regions.txt', 'r').read().split('\n')[1:-1]

for n in range(14,len(systems_tofix)):
    system = systems_tofix[n]
    print(system)
    index= system_index(system)
    ...
    systemsplit = system.split('_')
    date, res_nores, sim_no = systemsplit[0], systemsplit[1], systemsplit[2]    
    ...
    f = open('/home/garvit/Downloads/Exomoon_project/modified_lightcurves/final_lightcurve_{}_{}_{}.csv'.format(date, res_nores, sim_no), 'w')
