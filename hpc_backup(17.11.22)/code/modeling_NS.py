...
log_dir_planet_only="/tiara/home/gagarwal/modeling_results/{}_NS/planet_only/".format(system)
log_dir_planet_moon="/tiara/home/gagarwal/modeling_results/{}_NS/planet_moon/".format(system)
...
if(len(sys.argv)==5 and sys.argv[4]=='resume'):
	...
	listt = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}/prior_random_shifts_NS_{}.txt'.format(system, modeling_type), 'r').readlines()
	...
	f = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}/prior_random_shifts_NS_{}.txt'.format(system, modeling_type), 'w')
