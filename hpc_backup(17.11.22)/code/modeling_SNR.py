...
f = open("/tiara/home/gagarwal/files_and_data/final_lightcurves_SNR/{}".format(filename), 'r')
...
noise = float(open("/tiara/home/gagarwal/files_and_data/uncertainties_commonSNR.txt", 'r').readlines()[index])
...
log_dir_planet_only="/tiara/home/gagarwal/modeling_results/{}_SNR/planet_only/".format(system)
log_dir_planet_moon="/tiara/home/gagarwal/modeling_results/{}_SNR/planet_moon/".format(system)

os.system('mkdir -p /tiara/home/gagarwal/files_and_data/prior_random_shifts/{}_SNR/'.format(system))

if(len(sys.argv)==5 and sys.argv[4]=='resume'):
	resume = 'resume-similar'
	listt = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}_SNR/prior_random_shifts_{}.txt'.format(system, modeling_type), 'r').readlines()
	...
	f = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}_SNR/prior_random_shifts_{}.txt'.format(system, modeling_type), 'w')
