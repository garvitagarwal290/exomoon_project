...
log_dir_planet_only="/tiara/home/gagarwal/modeling_results/{}_FR/planet_only/".format(system)
log_dir_planet_moon="/tiara/home/gagarwal/modeling_results/{}_FR/planet_moon/".format(system)

os.system('mkdir -p /tiara/home/gagarwal/files_and_data/prior_random_shifts/{}/'.format(system))

if(len(sys.argv)==5 and sys.argv[4]=='resume'):
	resume = 'resume-similar'
	listt = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}/prior_random_shifts_FR_{}.txt'.format(system, modeling_type), 'r').readlines()
	...
	f = open('/tiara/home/gagarwal/files_and_data/prior_random_shifts/{}/prior_random_shifts_FR_{}.txt'.format(system, modeling_type), 'w')
...
result = sampler.run(min_num_live_points=1000, frac_remain=0.003)
