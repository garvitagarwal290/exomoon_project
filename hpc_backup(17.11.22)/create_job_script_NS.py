...
job_name = simno +'_NS_'+ modeling_type  + '_' + job_line[-1]
job_line[-1] = job_name
lines[2] = ' '.join(job_line)

outline = lines[4].split('/')
outline[-1] = "output_"+ simno + '_NS_' + system_split[0]+'_'+system_split[1] +"_"+modeling_type
lines[4] = '/'.join(outline)+'\n'

errline = lines[5].split('/')
errline[-1] = "error_"+ simno + '_NS_' + system_split[0]+'_'+system_split[1] +"_"+modeling_type
lines[5] = '/'.join(errline)+'\n'


if(resume):
	lines[21] = 'python /tiara/home/gagarwal/code/modeling_NS.py {} {} {} resume\n'.format(systemno, modeling_type, frac)
else:
	lines[21] = 'python /tiara/home/gagarwal/code/modeling_NS.py {} {} {}\n'.format(systemno, modeling_type, frac)
